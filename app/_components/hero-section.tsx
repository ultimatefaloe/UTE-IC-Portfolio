              ...
              <div className="row w-full">
                <div className="col-lg-6 w-full lg:w-1/2">
                  <div className="hero__text text-white">
                    ...
                    <Link
                      href="#"
                      className={`primary-btn inline-block bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-8 rounded-sm uppercase tracking-wide transition-all duration-300 transform hover:scale-105 ${
                        index === currentSlide
                          ? "translate-y-0 opacity-100"
                          : "translate-y-8 opacity-0"
                      }`}
