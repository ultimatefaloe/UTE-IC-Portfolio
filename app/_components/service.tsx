...
import { Camera, Edit3, Share2, Film, Layers, Database, Cloud, Code } from "lucide-react";
 ...
 const services = [
  {
    ...
    description:
      "Building responsive, scalable applications with Node.js, PHP, and React. From backend APIs to frontend UI, I deliver end-to-end solutions tailored to business needs.",
  },
  {
    id: 2,
    icon: Layers,
          ...
          <div className="lg:col-span-1">
            <div className="services__title">
              <div className="section-title mb-8">
                ...
                {/* Cyan accent line */}
                <div className={`w-16 h-1 mb-8 bg-red-600`}></div>
              </div>
              ...
              <div className="relative inline-block">
                <button
                  className={`relative cursor-pointer px-8 py-4 font-semibold text-sm tracking-wider uppercase transition-all duration-300 hover:text-red-600 hover:bg-red-600/10
                    ${theme === "light" ? "text-gray-900" : "text-white"}`}
              ...
              {services.map((service, index) => {
                ...
                return (
                  ...
                  >
                    {/* Icon with border */}
                    <div
                      className={`services__item__icon mb-8 inline-flex items-center justify-center w-20 h-20 border-2 border-red-600 transition-all duration-300 hover:bg-red-600/10`}
                    >
